<style>/** Dark mode depending on OS setting **/ @media (prefers-color-scheme: dark) { body { color: #eee; background: #293656;  }        a {            color: #7a9bff;        }    } .text-gray {    color: #000 !important;} </style>
<!--
